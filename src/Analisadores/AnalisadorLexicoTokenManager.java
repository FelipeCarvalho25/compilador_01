...
private static final int jjStopStringLiteralDfa_0(int pos, long active0)
{
   ...
   {
      case 0:
         if ((active0 & 0x8200000004fffeL) != 0L)
         {
            jjmatchedKind = 47;
            return -1;
         }
...
static private int jjMoveStringLiteralDfa0_0()
{
   switch(curChar)
   {
      ...
      case 45:
         return jjStartNfaWithStates_0(0, 29, 13);
      case 46:
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 3:
                  ...
                  break;
               case 4:
                  if ((0xffffffff00000000L & l) != 0L && kind > 47)
                     kind = 47;
                  break;
               case 13:
   ...
   switch(jjmatchedKind)
   {
      ...
      case 45 :
        if (image == null)
            image = new StringBuffer();
        image.append(input_stream.GetSuffix(jjimageLen + (lengthOfMatch = jjmatchedPos + 1)));
                                                   mensages_manhosas.append("NUMERO NATURAIS -> "+image+"\r\n");
         break;
      case 46 :
        if (image == null)
            image = new StringBuffer();
        image.append(input_stream.GetSuffix(jjimageLen + (lengthOfMatch = jjmatchedPos + 1)));
                                                                                                           mensages_manhosas.append("NUMERO REAL -> "+image+"\r\n");
         break;
      case 47 :
        if (image == null)
            image = new StringBuffer();
        image.append(input_stream.GetSuffix(jjimageLen + (lengthOfMatch = jjmatchedPos + 1)));
                                 mensages_manhosas.append( "CHAR -> "+image+"\r\n");
         break;
      case 48 :
        if (image == null)
            image = new StringBuffer();
        image.append(input_stream.GetSuffix(jjimageLen + (lengthOfMatch = jjmatchedPos + 1)));
                                               mensages_manhosas.append("BOOLEAN -> "+image+"\r\n");
         break;
      default : 
         break;
   }
